...
- [x] Add severity, compliance mapping, and status filters with clear reset behavior.
- [x] Add evidence-backed PDF export for posture metrics and filtered findings.
