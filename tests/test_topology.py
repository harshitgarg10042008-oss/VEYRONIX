...
GRAPH = {"source_sha256": "a" * 64, "nodes": [{"id": "edge"}, {"id": "core"}, {"id": "db"}], "links": [{"source": "edge", "target": "core"}, {"source": "core", "target": "db"}]}
...
def test_analysis_links_finding_to_impacted_assets():
    ...
    assert "does not infer traffic flow" in result["analyses"]["finding-1"]["safety_note"]
