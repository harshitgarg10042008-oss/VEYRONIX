from configsentinel.frameworks import get_framework, normalize_framework_id, normalize_frameworks
...
def test_expanded_framework_aliases():
    ...
    assert normalize_frameworks(["hipaa", "soc2"]) == ("hipaa-security-rule", "soc-2-tsc")
