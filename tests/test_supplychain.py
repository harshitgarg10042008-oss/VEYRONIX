...
from configsentinel.supplychain import SupplyChainError, build_manifest, verify_manifest, write_manifest
...
def test_manifest_rejects_path_traversal():
    with pytest.raises(SupplyChainError):
        verify_manifest("/tmp", {"schema": "configsentinel.release-manifest.v1", "algorithm": "sha256", "files": {"../outside": "a"}})
